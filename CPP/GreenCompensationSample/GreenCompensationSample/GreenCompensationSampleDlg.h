// GreenCompensationSampleDlg.h : header file
//
...
class CGreenCompensationSampleDlg : public CDialog
{
    // Construction
public:
    CGreenCompensationSampleDlg(CWnd* pParent = NULL);	// standard constructor

    // Dialog Data
    enum { IDD = IDD_GREENCOMPENSATIONSAMPLE_DIALOG };
