// GreenCompensationSampleDlg.cpp : implementation file
//

#include "stdafx.h"
#include "GreenCompensationSample.h"
#include "GreenCompensationSampleDlg.h"
#include <VLib.h>
#include <vector>
...
// CGreenCompensationSampleDlg dialog

//--------------------------------------------------------------------------------------------------
// Constructor
//--------------------------------------------------------------------------------------------------
CGreenCompensationSampleDlg::CGreenCompensationSampleDlg(CWnd* pParent /*=NULL*/)
: CDialog(CGreenCompensationSampleDlg::IDD, pParent)
, m_iRThresh(250)
, m_iGThresh(240)
, m_iBThresh(220)
, m_iRGain(50)
...
void CGreenCompensationSampleDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CGreenCompensationSampleDlg, CDialog)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_START, &CGreenCompensationSampleDlg::OnBnClickedStart)
	ON_BN_CLICKED(IDC_STOP, &CGreenCompensationSampleDlg::OnBnClickedStop)
	ON_WM_HSCROLL()
	ON_NOTIFY(UDN_DELTAPOS, IDC_RTHRESHSPIN, &CGreenCompensationSampleDlg::OnDeltaposRthreshspin)
	ON_NOTIFY(UDN_DELTAPOS, IDC_GTHRESHSPIN, &CGreenCompensationSampleDlg::OnDeltaposGthreshspin)
	ON_NOTIFY(UDN_DELTAPOS, IDC_BTHRESHSPIN, &CGreenCompensationSampleDlg::OnDeltaposBthreshspin)
	ON_NOTIFY(UDN_DELTAPOS, IDC_RGAINSPIN, &CGreenCompensationSampleDlg::OnDeltaposRgainspin)
	ON_NOTIFY(UDN_DELTAPOS, IDC_GGAINSPIN, &CGreenCompensationSampleDlg::OnDeltaposGgainspin)
	ON_NOTIFY(UDN_DELTAPOS, IDC_BGAINSPIN, &CGreenCompensationSampleDlg::OnDeltaposBgainspin)
	ON_BN_CLICKED(IDC_FULL, &CGreenCompensationSampleDlg::OnBnClickedFull)
	ON_BN_CLICKED(IDC_COMPEN, &CGreenCompensationSampleDlg::OnBnClickedCompen)
	ON_BN_CLICKED(IDC_SAVE, &CGreenCompensationSampleDlg::OnBnClickedSave)
	ON_BN_CLICKED(IDCANCEL, &CGreenCompensationSampleDlg::OnBnClickedCancel)
	ON_BN_CLICKED(IDOK, &CGreenCompensationSampleDlg::OnBnClickedOk)
END_MESSAGE_MAP()


// CGreenCompensationSampleDlg message handlers

//--------------------------------------------------------------------------------------------------
// OnInitDialog
//--------------------------------------------------------------------------------------------------
BOOL CGreenCompensationSampleDlg::OnInitDialog()
{
...
// OnDestroy
//--------------------------------------------------------------------------------------------------
void CGreenCompensationSampleDlg::OnDestroy()
{
	CDialog::OnDestroy();
...
void CGreenCompensationSampleDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CGreenCompensationSampleDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

void CGreenCompensationSampleDlg::ShowErrorMsg(CString message, J_STATUS_TYPE error)
{
	CString errorMsg;
...
//--------------------------------------------------------------------------------------------------
BOOL CGreenCompensationSampleDlg::OpenFactoryAndCamera()
{
...
// CloseFactoryAndCamera
//--------------------------------------------------------------------------------------------------
void CGreenCompensationSampleDlg::CloseFactoryAndCamera()
{
	J_STATUS_TYPE   retval;
...
// OnBnClickedStart
//--------------------------------------------------------------------------------------------------
void CGreenCompensationSampleDlg::OnBnClickedStart()
{
	J_STATUS_TYPE   retval;
	int64_t int64Val;
    int64_t pixelFormat;
	...
	SetFramegrabberPixelFormat(m_hCam, NODE_NAME_PIXELFORMAT, (int64_t)jaiPixelFormat, &m_sCameraId[0]);
	...
	// Open stream
	retval = J_Image_OpenStream(m_hCam, 0, reinterpret_cast<J_IMG_CALLBACK_OBJECT>(this), reinterpret_cast<J_IMG_CALLBACK_FUNCTION>(&CGreenCompensationSampleDlg::StreamCBFunc), &m_hThread, (ViewSize.cx*ViewSize.cy*bpp)/8);
	if (retval != J_ST_SUCCESS) {
...
// StreamCBFunc
//--------------------------------------------------------------------------------------------------
void CGreenCompensationSampleDlg::StreamCBFunc(J_tIMAGE_INFO * pAqImageInfo)
{
	if(m_hView)
	{
...
// OnBnClickedStop
//--------------------------------------------------------------------------------------------------
void CGreenCompensationSampleDlg::OnBnClickedStop()
{
	J_STATUS_TYPE retval;
...
// InitializeControls
//--------------------------------------------------------------------------------------------------
void CGreenCompensationSampleDlg::InitializeControls()
{
	J_STATUS_TYPE   retval;
	NODE_HANDLE hNode;
	int64_t int64Val;
...
// EnableControls
//--------------------------------------------------------------------------------------------------
void CGreenCompensationSampleDlg::EnableControls(BOOL bIsCameraReady, BOOL bIsImageAcquiring)
{
...
// OnHScroll
//--------------------------------------------------------------------------------------------------
void CGreenCompensationSampleDlg::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
	// Get SliderCtrl for Width
	CSliderCtrl* pSCtrl;
	int iPos;
...
void CGreenCompensationSampleDlg::OnDeltaposRthreshspin(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CGreenCompensationSampleDlg::OnDeltaposGthreshspin(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
...
void CGreenCompensationSampleDlg::OnDeltaposBthreshspin(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
...
void CGreenCompensationSampleDlg::OnDeltaposRgainspin(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
...
void CGreenCompensationSampleDlg::OnDeltaposGgainspin(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
...
void CGreenCompensationSampleDlg::OnDeltaposBgainspin(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
...
void CGreenCompensationSampleDlg::OnBnClickedFull()
{
...
void CGreenCompensationSampleDlg::OnBnClickedCompen()
{
...
void CGreenCompensationSampleDlg::OnBnClickedSave()
{
	m_bSave = true;
}

void CGreenCompensationSampleDlg::OnBnClickedCancel()
{
	OnCancel();
}

void CGreenCompensationSampleDlg::OnBnClickedOk()
{
	OnOK();
}
