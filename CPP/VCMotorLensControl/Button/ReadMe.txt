================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Button プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Button には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Button アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Button.h
   ...
   CButtonApp アプリケーション クラスを宣言します。

Button.cpp
   これは、アプリケーション クラス CButtonApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Button.ico
   ...
   アイコンはメイン リソース ファイル Button.rc に含まれていま
   す。
...
ButtonDlg.h, ButtonDlg.cpp - ダイアログ
   これらのファイルは CButtonDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Button.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Button.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
