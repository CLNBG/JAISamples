================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Wheel プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Wheel には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Wheel アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Wheel.h
   ...
   CWheelApp アプリケーション クラスを宣言します。

Wheel.cpp
   これは、アプリケーション クラス CWheelApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Wheel.ico
   ...
   アイコンはメイン リソース ファイル Wheel.rc に含まれていま
   す。
...
WheelDlg.h, WheelDlg.cpp - ダイアログ
   これらのファイルは CWheelDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Wheel.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Wheel.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
