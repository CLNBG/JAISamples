...
unsigned int __stdcall ImageProcessThreadCaller(void * pParam)
{
    // The ImageThread function of the CImageProcessingThreadSampleDlg class is called.
    // The worker thread loops in the ImageThread function.
    ((CImageProcessingThreadSampleDlg *)pParam)->ImageThread(pParam);
...
// Constructor
//--------------------------------------------------------------------------------------------------
CImageProcessingThreadSampleDlg::CImageProcessingThreadSampleDlg(CWnd* pParent /*=NULL*/)
: CDialog(CImageProcessingThreadSampleDlg::IDD, pParent)
, m_pImageWnd(NULL)
, m_pDiBmp(NULL)
, m_hBitmap(NULL)
, m_iAfterProcess(0)
...
void CImageProcessingThreadSampleDlg::DoDataExchange(CDataExchange* pDX)
{
    CDialog::DoDataExchange(pDX);
    DDX_Control(pDX, IDC_AFTER_PROCESS, m_oAfterProcess);
}

BEGIN_MESSAGE_MAP(CImageProcessingThreadSampleDlg, CDialog)
    ON_WM_PAINT()
    ON_WM_QUERYDRAGICON()
    //}}AFX_MSG_MAP
    ON_WM_DESTROY()
    ON_BN_CLICKED(IDC_START, &CImageProcessingThreadSampleDlg::OnBnClickedStart)
    ON_BN_CLICKED(IDC_STOP, &CImageProcessingThreadSampleDlg::OnBnClickedStop)
    ON_WM_HSCROLL()
    ON_BN_CLICKED(IDC_AFTER_PROCESS, &CImageProcessingThreadSampleDlg::OnBnClickedAfterProcess)
	ON_BN_CLICKED(IDCANCEL, &CImageProcessingThreadSampleDlg::OnBnClickedCancel)
	ON_BN_CLICKED(IDOK, &CImageProcessingThreadSampleDlg::OnBnClickedOk)
END_MESSAGE_MAP()


// CImageProcessingThreadSampleDlg message handlers

//--------------------------------------------------------------------------------------------------
// OnInitDialog
//--------------------------------------------------------------------------------------------------
BOOL CImageProcessingThreadSampleDlg::OnInitDialog()
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////
    _beginthreadex(NULL, 0, ImageProcessThreadCaller, reinterpret_cast<void *>(this), 0, NULL);
    ////////////////////////////////////////////////////////////////////////////////////
...
// OnDestroy
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::OnDestroy()
{
    CDialog::OnDestroy();
...
void CImageProcessingThreadSampleDlg::OnPaint()
{
    if (IsIconic())
    {
...
HCURSOR CImageProcessingThreadSampleDlg::OnQueryDragIcon()
{
    return static_cast<HCURSOR>(m_hIcon);
}

void CImageProcessingThreadSampleDlg::ShowErrorMsg(CString message, J_STATUS_TYPE error)
{
    CString errorMsg;
...
//--------------------------------------------------------------------------------------------------
BOOL CImageProcessingThreadSampleDlg::OpenFactoryAndCamera()
{
	...
	m_oAfterProcess.EnableWindow(TRUE);
	m_oAfterProcess.SetCheck(FALSE);
	m_iAfterProcess = m_oAfterProcess.GetCheck();
...
// CloseFactoryAndCamera
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::CloseFactoryAndCamera()
{
    J_STATUS_TYPE   retval;
...
// OnBnClickedStart
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::OnBnClickedStart()
{
    J_STATUS_TYPE   retval;
    int64_t int64Val;
    ...
    retval = J_Image_OpenStream(m_hCam, 
        ...
        reinterpret_cast<J_IMG_CALLBACK_FUNCTION>(&CImageProcessingThreadSampleDlg::StreamCBFunc), 
        &m_hThread, 
...
// OnBnClickedStop
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::OnBnClickedStop()
{
    J_STATUS_TYPE retval;
...
// InitializeControls
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::InitializeControls()
{
    J_STATUS_TYPE   retval;
    NODE_HANDLE hNode;
    int64_t int64Val;
...
// EnableControls
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::EnableControls(BOOL bIsCameraReady, BOOL bIsImageAcquiring)
{
...
// OnHScroll
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
    // Get SliderCtrl for Width
    CSliderCtrl* pSCtrl;
    int iPos;
...
void CImageProcessingThreadSampleDlg::OnBnClickedAfterProcess()
{
    m_iAfterProcess = m_oAfterProcess.GetCheck();
}
...
//--------------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::StreamCBFunc(J_tIMAGE_INFO * pAqImageInfo)
{
...
//--------------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::ImageThread(void * pParam)
{
    BOOL	m_bExit = FALSE;
    ...
    do
    {
        ...
        switch(WaitForMultipleObjects(2, hEvents, FALSE, 2000))
        {
...
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::CheckCreateBmp(J_tIMAGE_INFO * pImageInfo)
{
    // If DIB is defined
    if(m_hBitmap != NULL)
    {
    ...
    // The display processing is CImageWnd::OnPaint.
...
//--------------------------------------------------------------------------------------------------
void CImageProcessingThreadSampleDlg::BitInvert(J_tIMAGE_INFO * pImageInfo)
{
    int	iByteWord;
    int	iPixelStep;
    uint8_t		*pPixel8;
...
void CImageProcessingThreadSampleDlg::OnBnClickedCancel()
{
	OnCancel();
}

void CImageProcessingThreadSampleDlg::OnBnClickedOk()
{
	OnOK();
}
