// SimpleImageDisplaySampleDlg.h : header file
//
...
class CSimpleImageDisplaySampleDlg : public CDialog
{
    // Construction
public:
    CSimpleImageDisplaySampleDlg(CWnd* pParent = NULL);	// standard constructor

    // Dialog Data
    enum { IDD = IDD_SIMPLEIMAGEDISPLAYSAMPLE_DIALOG };
