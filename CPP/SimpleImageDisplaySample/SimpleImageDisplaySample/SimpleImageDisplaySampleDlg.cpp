// SimpleImageDisplaySampleDlg.cpp : implementation file
//

#include "stdafx.h"
#include "SimpleImageDisplaySample.h"
#include "SimpleImageDisplaySampleDlg.h"
#include <vector>
...
// CSimpleImageDisplaySampleDlg dialog

//--------------------------------------------------------------------------------------------------
// Constructor
//--------------------------------------------------------------------------------------------------
CSimpleImageDisplaySampleDlg::CSimpleImageDisplaySampleDlg(CWnd* pParent /*=NULL*/)
: CDialog(CSimpleImageDisplaySampleDlg::IDD, pParent)
{
...
void CSimpleImageDisplaySampleDlg::DoDataExchange(CDataExchange* pDX)
{
    CDialog::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CSimpleImageDisplaySampleDlg, CDialog)
    ON_WM_PAINT()
    ON_WM_QUERYDRAGICON()
    //}}AFX_MSG_MAP
    ON_WM_DESTROY()
    ON_BN_CLICKED(IDC_START, &CSimpleImageDisplaySampleDlg::OnBnClickedStart)
    ON_BN_CLICKED(IDC_STOP, &CSimpleImageDisplaySampleDlg::OnBnClickedStop)
    ON_WM_HSCROLL()
	ON_BN_CLICKED(IDCANCEL, &CSimpleImageDisplaySampleDlg::OnBnClickedCancel)
	ON_BN_CLICKED(IDOK, &CSimpleImageDisplaySampleDlg::OnBnClickedOk)
END_MESSAGE_MAP()


// CSimpleImageDisplaySampleDlg message handlers

//--------------------------------------------------------------------------------------------------
// OnInitDialog
//--------------------------------------------------------------------------------------------------
BOOL CSimpleImageDisplaySampleDlg::OnInitDialog()
{
...
// OnDestroy
//--------------------------------------------------------------------------------------------------
void CSimpleImageDisplaySampleDlg::OnDestroy()
{
    CDialog::OnDestroy();
...
void CSimpleImageDisplaySampleDlg::OnPaint()
{
    if (IsIconic())
    {
...
HCURSOR CSimpleImageDisplaySampleDlg::OnQueryDragIcon()
{
    return static_cast<HCURSOR>(m_hIcon);
}

void CSimpleImageDisplaySampleDlg::ShowErrorMsg(CString message, J_STATUS_TYPE error)
{
	CString errorMsg;
...
//--------------------------------------------------------------------------------------------------
BOOL CSimpleImageDisplaySampleDlg::OpenFactoryAndCamera()
{
...
// CloseFactoryAndCamera
//--------------------------------------------------------------------------------------------------
void CSimpleImageDisplaySampleDlg::CloseFactoryAndCamera()
{
    J_STATUS_TYPE   retval;
...
// OnBnClickedStart
//--------------------------------------------------------------------------------------------------
void CSimpleImageDisplaySampleDlg::OnBnClickedStart()
{
    J_STATUS_TYPE   retval;
    int64_t int64Val;
...
// OnBnClickedStop
//--------------------------------------------------------------------------------------------------
void CSimpleImageDisplaySampleDlg::OnBnClickedStop()
{
    J_STATUS_TYPE retval;
...
// InitializeControls
//--------------------------------------------------------------------------------------------------
void CSimpleImageDisplaySampleDlg::InitializeControls()
{
    J_STATUS_TYPE   retval;
    NODE_HANDLE hNode;
    int64_t int64Val;
	...
	{
		// Get Width Node
		retval = J_Camera_GetNodeByName(m_hCam, (int8_t *)NODE_NAME_WIDTH, &hNode);
		if (retval == J_ST_SUCCESS)
		{
			// Get/Set Min
	...
	{
		// Get Height Node
		retval = J_Camera_GetNodeByName(m_hCam, (int8_t *)NODE_NAME_HEIGHT, &hNode);
    ...
    // Get Gain Node
    retval = J_Camera_GetNodeByName(m_hCam, (int8_t *)NODE_NAME_GAIN, &hNode);
    if (retval == J_ST_SUCCESS)
    {
        // Get/Set Min
        retval = J_Node_GetMinInt64(hNode, &int64Val);
...
// EnableControls
//--------------------------------------------------------------------------------------------------
void CSimpleImageDisplaySampleDlg::EnableControls(BOOL bIsCameraReady, BOOL bIsImageAcquiring)
{
...
// OnHScroll
//--------------------------------------------------------------------------------------------------
void CSimpleImageDisplaySampleDlg::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
    // Get SliderCtrl for Width
    CSliderCtrl* pSCtrl;
    int iPos;
    ...
    if (pSCtrl == (CSliderCtrl*)pScrollBar) {
		...
		// Set Width value
		retval = J_Camera_SetValueInt64(m_hCam, (int8_t *)NODE_NAME_WIDTH, int64Val);
        if (retval != J_ST_SUCCESS)
        {
    ...
    if (pSCtrl == (CSliderCtrl*)pScrollBar) {
		...
		// Set Height Value
        retval = J_Camera_SetValueInt64(m_hCam, (int8_t *)NODE_NAME_HEIGHT, int64Val);
        if (retval != J_ST_SUCCESS)
        {
    ...
    if (pSCtrl == (CSliderCtrl*)pScrollBar) {
        ...
        // Get Height Node
        retval = J_Camera_SetValueInt64(m_hCam, (int8_t *)NODE_NAME_GAIN, int64Val);
        if (retval != J_ST_SUCCESS)
        {
...
void CSimpleImageDisplaySampleDlg::OnBnClickedCancel()
{
	OnCancel();
}

void CSimpleImageDisplaySampleDlg::OnBnClickedOk()
{
	OnOK();
}
